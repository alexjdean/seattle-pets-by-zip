...
// Seattle ZIP codes with approximate coordinates
const ZIP_COORDINATES = {
  ...
  '98110': [47.6028, -122.5072],
  '98112': [47.6342, -122.3022],
  '98113': [47.7186, -122.3289],
  ...
  '98148': [47.4553, -122.3156],
  '98154': [47.5986, -122.3278],
  '98155': [47.7553, -122.3000],
  '98158': [47.4358, -122.3106],
  '98160': [47.4011, -122.3228],
  '98166': [47.4628, -122.3253],
...
const MapComponent = ({ zipCodeData, selectedSpecies }) => {
  ...
  // Filter zip codes that have coordinates and data
  const mappableData = zipCodeData.filter(item => ZIP_COORDINATES[item.zipCode]);
    ...
    <div className="map-container">
      ...
      >
        ...
        {mappableData.map((item) => {
          const position = ZIP_COORDINATES[item.zipCode];
